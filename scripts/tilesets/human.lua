...
M.tiles[4] = { solid = true, frames = { 4, 5, 4 }, anim_key = 'attack_south', duration = 100 }
...
M.tiles[10] = { solid = true, frames = { 10, 11, 7 }, anim_key = 'attack_north', duration = 100 }
...
M.tiles[16] = { solid = true, frames = { 16, 17, 13 }, anim_key = 'attack_east', duration = 100 }
...
M.tiles[22] = { solid = true, frames = { 22, 23, 19}, anim_key = 'attack_west', duration = 100 }
